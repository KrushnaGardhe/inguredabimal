...
function ImageAndLocationPage({
  ...
  return (
    <div className="relative z-[3] h-screen w-full flex flex-col gap-3 justify-center items-center overflow-x-hidden bg-gray-200">
      ...
      <Rodal
        ...
        closeOnEsc
        className="bg-gray-100 bg-opacity-60  backdrop-blur-md "
        width={360}
        height={290}
      >
