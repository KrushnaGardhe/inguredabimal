...
function LoginRegisterForm() {
 ...
 <div className="min-h-screen bg-gray-50">
      <form className="flex gap-[20px] items-center justify-center flex-col">
        {!isLogin && (
          <>
            <h1 className=" mt-[60px] text-center pb-1 pl-2 pr-2 z-[3] text-    font-bold text-[2.5em] underline">Create account</h1>
            <InputField
      ...
      {error && <p className="absolute top-[-25px] w-screen tracking-wide text-red-500 font-semibold text-center">{error}</p>}
        ...
        {!isLogin && (
          <>
          <div className="w-screen h-fit flex flex-col mt-3 gap-2 items-center text-Black">
          <LoginTextLink
